...
function MyApp() {
  useEffect(() => {
    ...
    // Create planets
    const mercury = createPlanet(1, './images/mercury_texture.jpg', 35, 0, 0, 0.004, 0.03);
    const venus = createPlanet(1.4, './images/venus_texture.jpg', 41, 0, 0, 0.002, 0.02);
    const earth = createPlanet(1.7, './images/earth_texture.jpg', 50, 0, 0, 0.002, 0.01);
    const mars = createPlanet(1.3, './images/mars_texture.jpg', 55, 0, 0, 0.018, 0.006);
    const jupiter = createPlanet(9, './images/jupiter_texture.jpg', 70, 0, 0, 0.004, 0.002);
    const saturn = createPlanet(8, './images/saturn_texture.jpg', 98, 0, 0, 0.038, 0.0008);

    //rings Saturn
    const ringGeometry = new THREE.TorusGeometry(14, 2, 2, 100);
    const textureRing = new THREE.TextureLoader().load('./images/ringSaturn_texture.jpg');
    ...
    //uranus planet
    const uranus = createPlanet(4, './images/uranus_texture.jpg', 120, 0, 0, 0.003, 0.0004);
    ...
    //Neptune
    const neptune = createPlanet(3.94, './images/neptune_texture.jpg', 130, 0, 0, 0.032, 0.0001);
    //Neptune's Ring
    const ringNeptuneGeometry = new THREE.TorusGeometry(4.5, 0.1, 2, 100);
    const ringNeptuneTexture = new THREE.TextureLoader().load('./images/neptune_rings.jpg');
    ...
    //sun
    const textureSun = new THREE.TextureLoader().load('./images/sun_texture.jpg')
